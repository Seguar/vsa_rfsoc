classdef rxBoardControl_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        rxBoardControlUIFigure  matlab.ui.Figure
    ...
    methods (Access = private)
        ...
        function LoadRegsButtonPushed(app, event)
            ...
            if isfield(data,'registers')
                ...
                uialert(app.rxBoardControlUIFigure,'File does not contain registers','Load Error');
            end
        end
        ...
        % Close request function: rxBoardControlUIFigure
        function rxBoardControlUIFigureCloseRequest(app, event)
            delete(app)
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create rxBoardControlUIFigure and hide until all components are created
            app.rxBoardControlUIFigure = uifigure('Visible', 'off');
            app.rxBoardControlUIFigure.Position = [100 100 632 308];
            app.rxBoardControlUIFigure.Name = 'rxBoardControl';
            app.rxBoardControlUIFigure.CloseRequestFcn = createCallbackFcn(app, @rxBoardControlUIFigureCloseRequest, true);

            % Create ChoseportandpressthebuttonButton
            app.ChoseportandpressthebuttonButton = uibutton(app.rxBoardControlUIFigure, 'push');
            ...
            app.RX4_DAC_ISpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.PortListDropDownLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX4_DAC_QSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.RX4_DAC_ISpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.PortListDropDown = uidropdown(app.rxBoardControlUIFigure);
            ...
            app.RX3_DAC_ISpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.VCSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX3_DAC_QSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            % Create VCSpinner
            app.VCSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.RX2_DAC_ISpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.RFSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX2_DAC_QSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            % Create RFSpinner
            app.RFSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.RX1_DAC_ISpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.CBBSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX4_DAC_QSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX1_DAC_QSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            % Create CBBSpinner
            app.CBBSpinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.RX3_DAC_ISpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX3_DAC_QSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX2_DAC_ISpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX2_DAC_QSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX1_DAC_ISpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.RX1_DAC_QSpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            app.R1SpinnerLabel = uilabel(app.rxBoardControlUIFigure);
            ...
            % Create R1Spinner
            app.R1Spinner = uispinner(app.rxBoardControlUIFigure);
            ...
            app.SaveRegsButton = uibutton(app.rxBoardControlUIFigure, 'push');
            ...
            app.LoadRegsButton = uibutton(app.rxBoardControlUIFigure, 'push');
            ...
            app.rxBoardControlUIFigure.Visible = 'on';
        end
    end
    ...
    methods (Access = public)
        ...
        function app = rxBoardControl_exported
            ...
            if isempty(runningApp)
                ...
                registerApp(app, app.rxBoardControlUIFigure)
                ...
                figure(runningApp.rxBoardControlUIFigure)
        ...
        function delete(app)
            ...
            delete(app.rxBoardControlUIFigure)
        end
    end
end