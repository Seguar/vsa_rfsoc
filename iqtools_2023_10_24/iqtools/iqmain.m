...
% Last Modified by GUIDE v2.5 10-Jan-2023 16:49:36
...
set(handles.bottomText, 'String', [iqversion() suffix]);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (iqoptcheck([], {'M8190A_12bit', 'M8190A_14bit', 'M8195A_1ch', 'M8195A_1ch_mrk', 'M8195A_2ch', 'M8195A_2ch_mrk', 'M8195A_2ch_dupl', 'M8195A_4ch'}, 'SEQ'))
    iqpicspec();
end
