...
set(handles.editPMFormula, 'TooltipString', sprintf([ ...
    ...
    'The expression will be evaluated with x set to a row-vector with\n' ...
    'values in the range [0...1). The expression should return a row-vector\n' ...
    'with the same length as x and values representing the phase in degrees.\n' ...
...
elseif (strcmpi(modType, 'Custom Phase Code'))
    set(handles.textPMFormula, 'Enable', 'on');
    set(handles.editPMFormula, 'Enable', 'on');
    set(handles.textFMFormula, 'Enable', 'off');
    set(handles.editFMFormula, 'Enable', 'off');
...
pri = iqparse(get(handles.editPRI, 'String'), 'vector');
pw = iqparse(get(handles.editPW, 'String'), 'vector');
riseTime = iqparse(get(handles.editRise, 'String'), 'vector');
fallTime = iqparse(get(handles.editFall, 'String'), 'vector');
...
%         xfprintf(f, ':ABOR; :INST:DACM DUAL');
%     end
% end
...
try
    ...
    freq = iqparse(get(handles.editOffset, 'String'), 'vector');
...
fallTime = iqparse(get(handles.editFall, 'String'), 'vector');
amplitude = iqparse(get(handles.editAmplitude, 'String'), 'vector');
span_f = iqparse(get(handles.editSpan, 'String'), 'vector');
offset_f = iqparse(get(handles.editOffset, 'String'), 'vector');
...
riseTime = iqparse(get(handles.editRise, 'String'), 'vector');
fallTime = iqparse(get(handles.editFall, 'String'), 'vector');
delay = iqparse(get(handles.editInitialDelay, 'String'), 'vector');
phase = iqparse(get(handles.editInitialPhase, 'String'), 'vector');
...
try
    ...
    val = iqparse(get(handles.editCustomIQ, 'String'), 'vector');
    err = [];
catch ex
    err = ex.message;
end
...
value = NaN;
try
    value = iqparse(get(handles.editSpan, 'String'), 'vector');
catch
end
