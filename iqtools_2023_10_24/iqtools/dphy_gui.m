...
dParam.lpDataRate = iqparse(get(handles.editLPdataRate, 'String'), 'scalar');
dParam.hsDataRate = iqparse(get(handles.editHSdataRate, 'String'), 'scalar');
dParam.lpLow = iqparse(get(handles.editLPlow, 'String'), 'scalar');
dParam.hsLow = iqparse(get(handles.editHSlow, 'String'), 'scalar');
dParam.lpHigh = iqparse(get(handles.editLPhigh, 'String'), 'scalar');
dParam.hsHigh = iqparse(get(handles.editHShigh, 'String'), 'scalar');
if (get(handles.checkboxLPenable, 'Value'))
    dParam.lpPattern = iqparse(get(handles.editLPpattern, 'String'), 'vector');
else
    dParam.lpPattern = [];
end
dParam.hsPattern = iqparse(get(handles.editHSpattern, 'String'), 'vector');
dParam.lpTT = iqparse(get(handles.editLPtt, 'String'), 'vector');
dParam.hsTT = iqparse(get(handles.editHStt, 'String'), 'vector');
dParam.lpIsi = iqparse(get(handles.editLPisi, 'String'), 'vector');
dParam.hsIsi = iqparse(get(handles.editHSisi, 'String'), 'vector');
dParam.lpJitter = iqparse(get(handles.editLPjitter, 'String'), 'vector');
dParam.hsJitter = iqparse(get(handles.editHSjitter, 'String'), 'vector');
dParam.lpJitterFreq = iqparse(get(handles.editLPjitterFreq, 'String'), 'vector');
dParam.hsJitterFreq = iqparse(get(handles.editHSjitterFreq, 'String'), 'vector');
dParam.DelayA = iqparse(get(handles.editDelayA, 'String'), 'vector') * 1e-12;
dParam.DelayB = iqparse(get(handles.editDelayB, 'String'), 'vector') * 1e-12;
dParam.DelayC = iqparse(get(handles.editDelayC, 'String'), 'vector') * 1e-12;
dParam.CMAmpl = iqparse(get(handles.editCMAmpl, 'String'), 'vector');
dParam.CMFreq = iqparse(get(handles.editCMFreq, 'String'), 'vector');
dParam.ClockHigh =  iqparse(get(handles.editClockHigh, 'String'), 'vector');
dParam.ClockLow =   iqparse(get(handles.editClockLow, 'String'), 'vector');
dParam.ClockDelay = iqparse(get(handles.editClockDelay, 'String'), 'vector');
...
delay = [];
try
    delay = iqparse(get(handles.editDelayA, 'String'), 'scalar');
catch
end
...
switch(handles.mode)
    ...
    case 'DPHY'
        ...
        handles.channelNames = {'D+', 'D-', 'D-', 'Clock'};
end
% Update handles structure
guidata(hObject, handles);
arbConfig = loadArbConfig();
...
sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
hsDataRate = iqparse(get(handles.editHSdataRate, 'String'), 'scalar');
hsTT = iqparse(get(handles.editHStt, 'String'), 'vector');
