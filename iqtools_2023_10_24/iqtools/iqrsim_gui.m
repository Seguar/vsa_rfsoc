...
if (isempty(find(strcmp(arbConfig.model, {'M8190A_12bit', 'M8190A_14bit', 'M8195A_1ch', 'M8195A_2ch', 'M8195A_2ch_mrk', 'M8195A_2ch_mrk', 'M8195A_4ch'}), 1)))
...
numSteps = iqparse(get(handles.editNumSteps, 'String'), 'vector');
amplRatio = iqparse(get(handles.editAmplitudeRatio, 'String'), 'vector');
...
tt = iqparse(get(handles.editTT, 'String'), 'vector');
...
extLO = iqparse(get(handles.editExtLO, 'String'), 'vector');
...
doppler = iqparse(get(handles.editDoppler, 'String'), 'vector');
