...
fall = 0;
try
    value = iqparse(get(handles.editPRISec, 'String'), 'scalar');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
    pw = iqparse(get(handles.editPWSec, 'String'), 'scalar');
    rise = iqparse(get(handles.editRiseSec, 'String'), 'scalar');
    fall = iqparse(get(handles.editFallSec, 'String'), 'scalar');
    off = iqparse(get(handles.editFallSec, 'String'), 'scalar');
catch ex
end
arbConfig = loadArbConfig();
...
sampleRate = 1;
try
    value = iqparse(get(handles.editPWSec, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
...
sampleRate = 1;
try
    value = iqparse(get(handles.editRiseSec, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1)
...
sampleRate = 1;
try
    value = iqparse(get(handles.editFallSec, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1)
...
iqplot(pulse, sampleRate, 'nospectrum', 'no_CCDF');
...
sampleRate = 1;
try
    value = iqparse(get(handles.editFallSamples, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
...
sampleRate = 1;
try
    value = iqparse(get(handles.editRiseSamples, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1e9 && isequal(floor(value),value))
...
sampleRate = 1;
try
    value = iqparse(get(handles.editPWSamples, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1e9 && isequal(floor(value),value))
...
sampleRate = 1;
try
    value = iqparse(get(handles.editPRISamples, 'String'), 'scalar');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
...
sampleRate = 1;
try
    value = iqparse(get(handles.editOffSec, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1)
...
sampleRate = 1;
try
    value = iqparse(get(handles.editOffSamples, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
if (isvector(value) && min(value) >= 0 && max(value) <= 1e9 && isequal(floor(value),value))
...
try
    pw = iqparse(get(handles.editPWSamples, 'String'), 'vector');
    rise = iqparse(get(handles.editRiseSamples, 'String'), 'vector');
    fall = iqparse(get(handles.editFallSamples, 'String'), 'vector');
    off = iqparse(get(handles.editOffSamples, 'String'), 'vector');
    low = iqparse(get(handles.editLow, 'String'), 'vector');
    high = iqparse(get(handles.editHigh, 'String'), 'vector');
    sampleRate = iqparse(get(handles.editSampleRate, 'String'), 'scalar');
catch ex
end
...
alpha = iqparse(get(handles.editAlpha, 'String'), 'vector');
low = iqparse(get(handles.editLow, 'String'), 'vector');
high = iqparse(get(handles.editHigh, 'String'), 'vector');
...
value = [];
try
    value = iqparse(get(handles.editAlpha, 'String'), 'vector');
catch ex
end
