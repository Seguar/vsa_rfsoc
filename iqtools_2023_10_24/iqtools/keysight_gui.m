...
carrierFreq = iqparse(get(handles.editCarrierFrequency, 'String'), 'scalar');
duration = iqparse(get(handles.editDuration, 'String'), 'scalar');
steps = iqparse(get(handles.editSteps, 'String'), 'scalar');
wiggleRate = iqparse(get(handles.editWiggleRate, 'String'), 'scalar');
wiggleDepth = iqparse(get(handles.editWiggleDepth, 'String'), 'scalar');
wiggling = get(handles.checkboxWiggling, 'Value');
average = get(handles.checkboxAverage, 'Value');
extend = iqparse(get(handles.editExtend, 'String'), 'scalar');
